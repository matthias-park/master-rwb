...
const LoginDropdown = ({ dropdownClasses, toggleClasses }: Props) => {
  ...
  return (
    <Dropdown
      ...
      onToggle={isOpen => backdrop.toggle(isOpen, [ComponentName.Header])}
    >
      <Dropdown.Toggle
      ...
      <Dropdown.Menu className="login-dropdown__menu">
        ...
        >
          ...
          <div className="d-flex align-items-center flex-wrap">
            ...
            <a href="#" className="text-14 ml-auto login-dropdown__menu-link">
        ...
        <div className="lottery-club">
          ...
          <div className="lottery-club__text">
            <p className="text-14">
              Heb je geen wachtwoord, maar wel een Lottery Club kaartnummer?
            </p>
            <a href="#" className="text-14">
              <u>
                <strong>Registreer online met je kaart.</strong>
              </u>
            </a>
          </div>
        </div>
        <div className="d-flex flex-column align-items-center">
          ...
          <a href="#" className="btn btn-outline-primary my-2">
            Registreer je
          </a>
