...
export const NAVIGATION_ROUTES: ConfigRoute[] = [
  {
    path: '/',
    id: PagesName.HomePage,
    name: 'home',
  },
  {
    path: '/faq',
    id: PagesName.FaqPage,
    name: 'faq',
  },
  {
    path: '/sports',
  ...
  // {
  //   path: '/limits',
  //   id: PagesName.LimitsPage,
  //   protected: true,
  // },
  {
    path: '/settings',
    id: PagesName.SettingsPage,
    protected: true,
    name: 'settings',
  },
  {
    path: '/withdrawal',
    id: PagesName.WithdrawalPage,
    protected: true,
    name: 'withdrawal',
  },
  {
    path: '/sitemap',
    id: PagesName.SitemapPage,
    name: 'sitemap',
    hiddenSitemap: true,
  },
  {
    path: '/transactions',
    id: PagesName.TransactionsPage,
    protected: true,
    name: 'transactions',
  },
  {
    path: '/forgot_password',
    id: PagesName.ForgotPasswordPage,
    name: 'forgotPassword',
  },
  {
  ...
  {
    path: '/forgot_login',
    id: PagesName.ForgotLoginPage,
    name: 'forgotLogin',
  },
  {
    path: '/contact_us',
    id: PagesName.ContactUsPage,
    name: 'contactUs',
  },
  {
