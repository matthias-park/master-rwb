      ...
      <form>
          <div className="reg-form__block">
              ...
              <Form.Group>
                ...
                <label htmlFor="address" className="text-14">Straat, numer en bus</label>
                <div className="form-group__icons">
                    <i className="icon-check"></i>
                    <i className="icon-exclamation"></i>
                </div>
              ...
              <Form.Group>
                ...
                <label htmlFor="zip_code" className="text-14">Postcode/plaats</label>
                <div className="form-group__icons">
                    <i className="icon-check"></i>
                    <i className="icon-exclamation"></i>
                </div>
          ...
          <div className="reg-form__block">
              ...
              <Form.Group>
                ...
                <label htmlFor="email-confirm" className="text-14">Herhaal e-mail</label>
                <div className="form-group__icons">
                    <i className="icon-check"></i>
                    <i className="icon-exclamation"></i>
                </div>
